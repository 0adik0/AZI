			...
			case 0:
				...
				GUILayout.BeginHorizontal("box");
					...
					GUILayout.BeginVertical("box");
						...
						GUILayout.BeginHorizontal("box");
						GUILayout.FlexibleSpace();
                        if ((cancelStyle == null) ? GUILayout.Button("JPG") : GUILayout.Button("JPG", cancelStyle))
                        {
                            searchPattern = "*.jpg";
                            getFileList(currentDirectory);
                        }
                        if ((cancelStyle == null) ? GUILayout.Button("PNG") : GUILayout.Button("PNG", cancelStyle))
                        {
                            searchPattern = "*.png";
                            getFileList(currentDirectory);
                        }
                        if ((cancelStyle == null) ? GUILayout.Button("GIF") : GUILayout.Button("GIF", cancelStyle))
                        {
                            searchPattern = "*.gif";
                            getFileList(currentDirectory);
                        }
